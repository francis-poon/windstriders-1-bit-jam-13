...
classDiagram
	...
	class Table {
		...
		-float scroll_speed
		-int rows
		-Dictionary~Vector2i#44; bool~occupied_cells
		+_process(delta float)
		-_global_to_grid(global_pos Vector2) Vector2i
		-_reparent_dish(dish Dish)
		+can_place(dish Dish#44;global_pos Vector2) bool
		+place_dish(dish Dish#44; global_pos Vector2)
	}
...
sequenceDiagram
	...
	D->>D: shape = DishShapes.SHAPES[random]
